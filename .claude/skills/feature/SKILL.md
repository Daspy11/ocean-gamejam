---
name: feature
description: Implement a gameplay feature end to end (sim, unit tests, render, e2e, check).
---
...
4. If input or UI changed, extend `e2e/`.
5. Run `npm run check`; fix until green.
6. Reply with: files touched, new or changed actions and `World` fields, and how to try it in the browser (keys).
